...
class _trackingPetSoloState extends State<trackingPetSolo> {
  ...
  Future<void> getPolyPoints() async {
    if (_current == null) {
      uiHelper.customAlertBox(() {}, context, 'Ubicación no disponible aún');
      return;
    }
    ...
    try {
      final result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        request: PolylineRequest(
          origin: PointLatLng(_current!.latitude, _current!.longitude),
          destination: PointLatLng(pos.latitude, pos.longitude),
          mode: TravelMode.driving,          // driving, walking, etc.
          // wayPoints: [...],               // opcional
        ),
      );
      ...
      if (result.points.isNotEmpty) {
        ...
        // opcional: mostrar error de Google Directions API
        uiHelper.customAlertBox(() {}, context, result.errorMessage!);
      }
    } catch (ex) {
